    ...
    <div className='banner relative flex inset-x-0 h-screen w-screen z-30'>
        ...
        <div className='banner-filter absolute flex flex-wrap h-full w-full content-center bg-black opacity-45 z-35'></div>
            <div className=' banner-content flex flex-wrap absolute p-10 h-full sm:w-full md:w-2/3 z-40 justify-center sm:justify-start'>
                ...
                <p className=' text-main-color w-full chakra flex flex-wrap content-center text-[5vw] leading-[8vw] sm:text-[3vw] md:text-[3vw] sm:leading-[4.5vw] font-normal sm:font-thin xl:text-[2.5vw] z-40 text-center sm:text-justify xl:text-left xl:tracking-[0.4vw] xl:leading-[3vw]'>Découvrez notre séléction de produits locaux directement issus de l&apos;artisanat du Maroc. Nos produits sont un hommage aux traditions et à la richesse culturelle et agricole marocaine.</p>
